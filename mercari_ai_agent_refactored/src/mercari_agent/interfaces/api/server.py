...
用于启动Mercari AI Agent REST API服务器。
...
from mercari_agent.shared.utils.logger_utils import setup_logging, get_logger
from mercari_agent.interfaces.api.main import create_app
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description="Mercari AI Agent API服务器")
    parser.add_argument(
        "--host", 
        default=None, 
        help="服务器主机地址"
    ...
    if args.config:
        import os
        os.environ["MERCARI_CONFIG_PATH"] = args.config
